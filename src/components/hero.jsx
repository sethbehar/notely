...
export function Hero() {
  return (
    (<section className="bg-gradient-to-b font-poppins from-emerald-50 to-white py-20">
      <div className="flex flex-col items-center text-center">
        <Badge className="bg-emerald-500 font-normal">📓 Try It For Free Now 📓</Badge>
        <h1
          className="mt-6 max-w-3xl text-4xl font-semibold tracking-tight text-gray-900 sm:text-6xl">
